...
$UserRole =$_POST["UserRole"];
        ...
        $sql="UPDATE RegisterPatients SET SSN='$SSN',F_name ='$F_name',L_name='$L_n ame',Gender ='$Gender',CountryCode='$CountryCode',PatientPhone='$PatientPhone', PatientAddress='$PatientAddress', DateOfBirth='$DateOfBirth', HeightinCm='$HeightinCm',WeightinKg='$WeightinKg',Allergies='$Allergies',Email='$Email',UserPassword='$UserPassword',UserRole='$UserRole', WHERE SSN=$SSN";
